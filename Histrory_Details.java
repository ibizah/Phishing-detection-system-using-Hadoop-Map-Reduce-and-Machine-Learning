...
public class Histrory_Details extends javax.swing.JFrame {
public static Connection con=null;
public static Statement stmt=null;
public static ResultSet rs=null;
public static String url="jdbc:mysql://localhost:3306/phishing";
    public Histrory_Details() {
         try
        {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
        rs=stmt.executeQuery("SELECT `furl`,`date`,`formation` FROM history");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
        JOptionPane.showMessageDialog(this,"Histroy Cleared Sucessfully");
